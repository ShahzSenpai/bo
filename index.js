...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Shahril\n' //Ini Nama kontak lu
            + 'ORG: Creator Bot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=601156220735:+60 1156220735\n'  //ini kontak/nomor lu
            + 'END:VCARD'
...
fake = '© Created By Shah' //Ini fake
prefix = "#" // All Prefix Gayss
blocked = []   
limitawal = 30 //limit
memberlimit = 30 //maksimal member limit
cr1 = '*By AnggaGanzz*'
cr = '*AnggaGanzzNihbod*' //fake reply
LoLKey = "shahril" // BELI SU?
TobzKey = "291F6uRDLIhlSpHp1hOy" //APIKEY TOBZ
XteamKey = "AkiraBotWa" //BELI SU
AnggaKey = "AnggaGanz" // itu Di bawah Desk yt gw
namo = 'Robin' //Bisa ubah / ga tapi hati hati
ator = '+601156220735' //author
fakereply = '© Created By Shah' //fake reply
fakereply1 = '© Created By Shah' //fakereply

/******** OWNER NUMBER**********/
const ownerNumber = ["601156220735@s.whatsapp.net"]   //ganti nomor lu! 
const pacarNumber = ["601156220735@s.whatsapp.net"]  //ganti nomor lu!  
/************************************/
